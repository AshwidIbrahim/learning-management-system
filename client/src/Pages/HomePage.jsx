        ...
        <HomeLayout>
            ...
            <div className="h-screen flex lg:px-8 px-4 pb-8 lg:pb-0  flex-col lg:flex-row justify-around items-center">
                <div className="lg:px-4 md:px-4 space-y-8 lg:w-1/2">
                    <h1 className="lg:text-5xl text-2xl text-white font-semiboldbold ">LearnConnect <span className="text-yellow-500 font-bold">Online Learning Management System</span></h1>
